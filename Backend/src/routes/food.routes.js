...
// post /api/food/discount
router.post('/discount',authMiddleware.foodPartnerId , foodController.createFoodDiscount)

// get /api/food/discount
router.get('/discount', authMiddleware.userId, foodController.foodDiscountView)
